...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        <span className="font-extrabold text-secondary-white"> Metaverse </span>
        ...
        <span className="font-extrabold text-secondary-white">
          {" "}
          madness of the metaverse{" "}
        </span>
        of today, using only
        <span className="font-extrabold text-secondary-white"> VR </span>
        devices you can easily explore the metaverse world you want, turn your
        dreams into reality. Let's
        <span className="font-extrabold text-secondary-white"> Explore </span>
